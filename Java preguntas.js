document.addEventListener('DOMContentLoaded', () => {
    ...
    function manejarRespuesta(event) {
      ...
      if (esCorrecto) {
        puntaje++; // ✅ Aquí se suma el puntaje
    ...
    function manejarSiguiente(event) {
      ...
      if (preguntaActual < preguntas.length) {
        ...
        // ✅ Mostramos el puntaje y redirigimos a index.html
        alert(`¡Has completado el cuestionario!\nTu puntaje fue: ${puntaje} de ${preguntas.length} preguntas correctas.`);
        window.location.href = 'index.html'; // Asegúrate de que este archivo existe y esté en la misma carpeta
      }
    }
